  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      bonds.forEach(bond => {
        ...
        const fromX = 120 + (fromAtom.x - 120) * cosAngle - (fromAtom.y - 120) * sinAngle;
        const fromY = 120 + (fromAtom.x - 120) * sinAngle + (fromAtom.y - 120) * cosAngle;
        
        const toX = 120 + (toAtom.x - 120) * cosAngle - (toAtom.y - 120) * sinAngle;
        const toY = 120 + (toAtom.x - 120) * sinAngle + (toAtom.y - 120) * cosAngle;
